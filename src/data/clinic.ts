...
export const clinic = {
  ...
  email: "care@shushrutamved.com",
  address: "2nd Floor, Green Leaf Plaza, Civil Lines, Jaipur, Rajasthan 302006",
  hours: [
    { day: "Monday – Friday", time: "9:00 AM – 7:00 PM" },
    { day: "Saturday", time: "9:00 AM – 4:00 PM" },
    { day: "Sunday", time: "Online consultations only" },
  ],
  map: "https://www.google.com/maps?q=Civil+Lines+Jaipur&output=embed",
};
