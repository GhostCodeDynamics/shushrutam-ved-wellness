  ...
  head: () => ({
    meta: [
      { title: "About Dr. Aarti Sen | ShushrutamVed Care" },
      {
        name: "description",
        content:
          "Meet Dr. Aarti Sen, M.Sc. Biotechnology with 6+ years in naturopathy, lifestyle medicine, oncology nutrition and wellness at ShushrutamVed Care.",
      },
      { property: "og:title", content: "About Dr. Aarti Sen | ShushrutamVed Care" },
      {
