  ...
  head: () => ({
    meta: [
      { title: "Contact & Visit Us | ShushrutamVed Care" },
      {
        name: "description",
        content:
          "Reach ShushrutamVed Care by phone, WhatsApp or email. Clinic address, opening hours, map and appointment enquiry form.",
      },
      { property: "og:title", content: "Contact & Visit Us | ShushrutamVed Care" },
      {
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:py-24">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: MapPin, label: "Clinic", value: "Civil Lines, Jaipur", href: undefined },
          ].map((c, i) => (
