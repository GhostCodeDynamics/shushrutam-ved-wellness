  ...
  head: () => ({
    meta: [
      { title: "Frequently Asked Questions | ShushrutamVed Care" },
      {
        name: "description",
        content:
          "Answers about naturopathy consultations, timelines, online appointments, diet plans and combining natural care with existing medication.",
      },
      { property: "og:title", content: "Frequently Asked Questions | ShushrutamVed Care" },
      {
