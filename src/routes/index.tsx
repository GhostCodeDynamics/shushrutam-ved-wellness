...
import { Phone, ArrowRight, Check, MessageCircle, MapPin, Clock, Mail } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ShushrutamVed Care | Natural Healing for a Healthier Life" },
      {
        name: "description",
        content:
          "Premium naturopathy, nutrition and lifestyle medicine with Dr. Aarti Sen. Personalised natural care for weight, thyroid, PCOS, digestion, pain and stress.",
      },
      { property: "og:title", content: "ShushrutamVed Care | Natural Healing for a Healthier Life" },
      {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 pt-14 pb-20 lg:grid-cols-2 lg:pt-24 lg:pb-28">
          <Reveal>
            ...
            <h1 className="mt-6 font-display text-4xl leading-[1.08] font-semibold text-foreground sm:text-5xl lg:text-6xl">
              ...
              <span className="text-brand italic">Healthier Life</span>
            </h1>
