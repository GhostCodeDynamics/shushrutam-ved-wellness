  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy | ShushrutamVed Care" },
      {
        name: "description",
        content:
          "How ShushrutamVed Care collects, uses, stores and protects patient information shared through consultations and website enquiries.",
      },
      { property: "og:title", content: "Privacy Policy | ShushrutamVed Care" },
      {
        ...
        <div className="space-y-10">
          ...
          <Reveal>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              <a href={`mailto:${clinic.email}`} className="text-brand underline-offset-4 hover:underline">
                {clinic.email}
              </a>{" "}
